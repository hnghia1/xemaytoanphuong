...
<div class="w3layouts-main">
	...
	?>
		<form action="{{URL::to('/admin-dashboard')}}" method="post">
			@csrf
			<input type="email" class="ggg" id="username" name="email_admin" placeholder="E-MAIL" required="">
			<input type="password" class="ggg" id="password" name="password_admin" placeholder="PASSWORD" required="">
