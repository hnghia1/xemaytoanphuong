        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/tatca-loaixe')}}">Danh sách loại xe</a></li>
						<li><a href="{{URL::to('/them-loaixe')}}">Thêm loại xe</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>Quản lý dòng xe</span>
                    </a>
                    <ul class="sub">
                        <li><a href="{{URL::to('/tatca-dongxe')}}">Danh sách dòng xe</a></li>
                        <li><a href="{{URL::to('/them-dongxe')}}">Thêm dòng xe</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/tatca-xe')}}">Danh sách xe</a></li>
                        <li><a href="{{URL::to('/them-xe')}}">Thêm xe</a></li>
                    </ul>
                </li>
